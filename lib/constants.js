...
export const SSR_API_URL = ENV.SSR_API_URL || ENV.API_URL
...
export const APP_OPTIONS = !!ENV.APP_OPTIONS && ENV.APP_OPTIONS !== 'false' && ENV.APP_OPTIONS !== '0'

export const PUBLIC_BASE_URL = ENV.PUBLIC_BASE_URL
export const CDN_FRONTEND_BASE_URL = ENV.CDN_FRONTEND_BASE_URL || ENV.PUBLIC_BASE_URL
...
export const SALES_UP = ENV.SALES_UP
...
export const COOKIE_PORTAL_URL = ENV.COOKIE_PORTAL_URL
